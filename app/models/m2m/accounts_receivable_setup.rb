...
#  fcperiod         :integer(4)      default(0), not null
#  fdisctrinv       :boolean         default(FALSE), not null
#  fdueoffset       :integer(4)      default(0), not null
...
#  fmthno           :integer(4)      default(0), not null
#  fnover1          :integer(4)      default(0), not null
#  fnover2          :integer(4)      default(0), not null
#  fnover3          :integer(4)      default(0), not null
#  fnover4          :integer(4)      default(0), not null
