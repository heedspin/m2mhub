...
#  fcfromtype       :char(6)          default("      "), not null
...
#  FcAltUM          :char(3)          default("   "), not null
...
#  fcItemStatus     :char(20)         default("                    "), not null
