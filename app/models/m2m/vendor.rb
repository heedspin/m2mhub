...
#  fcuser1          :string(40)      default(" "), not null
#  fcuser2          :string(40)      default(" "), not null
#  fcuser3          :string(40)      default(" "), not null
...
#  flpaydate        :datetime        not null
#  flpayment        :decimal(, )     not null
