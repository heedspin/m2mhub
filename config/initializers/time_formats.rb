...
ActiveSupport::CoreExtensions::Date::Conversions::DATE_FORMATS[:purchase_date] = '%b %d, %Y'
...
ActiveSupport::CoreExtensions::Time::Conversions::DATE_FORMATS[:purchase_date] = '%b %d, %Y'
