...
ActionMailer::Base.smtp_settings = {  
  :address              => "smtp.gmail.com",  
  :port                 => 587,  
  :domain               => ENV['email_domain'] || CompanyConfig.email_domain,  
  :user_name            => ENV['email_address'] || CompanyConfig.email_address,
  :password             => ENV['email_password'] || CompanyConfig.email_password,
  :authentication       => "plain", 
  :enable_starttls_auto => true,
